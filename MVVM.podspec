...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Dao Nguyen V."
  # s.authors            = { "Dao Nguyen V." => "dao.nguyen@asiantech.vn" }
  # s.social_media_url   = "http://twitter.com/Dao Nguyen V."
  ...
  s.source       = { :git => "http://EXAMPLE/MVVM.git", :tag => "#{s.version}" }
